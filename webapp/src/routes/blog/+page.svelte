	...
	<section class="bg-helpo-light-gray py-20 lg:py-28">
		<div class="container mx-auto">
			<div class="mb-16 text-center">
				<p class="mb-4 text-sm font-bold uppercase tracking-[0.26em] text-helpo-purple">Blog</p>
					...
					{#each posts as post}
						<article class="group flex flex-col overflow-hidden rounded-sm bg-white shadow-sm transition-shadow hover:shadow-md">
							...
							<div class="flex flex-1 flex-col p-6">
								...
								<h2 class="mt-3 text-xl font-bold leading-snug text-helpo-heading">
